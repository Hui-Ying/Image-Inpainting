...
### Image Augmentation
In Figure Y, the image shows what the augmented dataset contains, which are randomly flipped, rotated, or slightly discolored versions of the ground truth images. The augmented dataset is used to imporve the training model by increasing the diversity of available dataset. 
